...
('حسام',        114, 1, 57, 1,  'backward', 10, 'بدأ من الناس متجهاً للخلف. مقرره الأخير مركّب من 3 مقاطع عير متصلة: الدخان 40-59، الزخرف حتى 28، من الطور إلى الحديد — راجع التفاصيل الدقيقة يدوياً'),
